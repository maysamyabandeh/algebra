...
public class DistRndMatrixJob extends AbstractJob {
  ...
  public static DistributedRowMatrix random(
      Configuration conf, int rows, int cols, Path tmpPath, String label) 
   ...
   */
  public void run(Configuration conf, Path inPath, 
...
//     ensures total order (when used with {@link MatrixOutputFormat}),
  ...
  public static class MyReducer
    ...
    public void reduce(WritableComparable<?> key,
        Iterable<NullWritable> nulls, Context context) throws IOException,
        InterruptedException {
